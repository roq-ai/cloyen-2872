  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless campaign management with Cloyen - Your one-stop solution to connect, manage and optimize ads across Facebook, Google, LinkedIn, Bing, and TikTok."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYW1wYWlnbiUyMG1hbmFnZW1lbnR8ZW58MHx8fHwxNjk0NTk5MTQzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless campaign management with Cloyen - Your one-stop solution to connect, manage and optimize ads across Facebook, Google, LinkedIn, Bing, and TikTok.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Marketing Manager" type="marketing-manager" abilities={appConfig.ownerAbilities} />
