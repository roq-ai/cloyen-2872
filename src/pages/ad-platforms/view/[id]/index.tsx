...
import { getAdPlatformById } from 'apiSdk/ad-platforms';
import { AdPlatformInterface } from 'interfaces/ad-platform';
import { AdCampaignListPage } from 'pages/ad-campaigns';

function AdPlatformViewPage() {
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('ad_platform', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/ad-platforms/edit/${id}`} passHref legacyBehavior>
                    <Button
