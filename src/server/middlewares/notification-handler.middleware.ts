...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'ad_campaign.create': {
    roles: ['business-owner', 'marketing-manager', 'ad-campaign-specialist'],
    key: 'ad-campaign-created',
    tenantPath: ['client', 'ad_campaign'],
    userPath: [],
  },
  'ad_campaign.update': {
    roles: ['business-owner', 'marketing-manager', 'ad-campaign-specialist'],
    key: 'ad-campaign-updated',
    tenantPath: ['client', 'ad_campaign'],
    userPath: [],
  },
  'ad_campaign.delete': {
    roles: ['business-owner', 'marketing-manager', 'ad-campaign-specialist'],
    key: 'ad-campaign-deleted',
    tenantPath: ['client', 'ad_campaign'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'marketing-manager', 'ad-campaign-specialist'];
